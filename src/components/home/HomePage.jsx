          ...
          <Card className="h-100 shadow-sm">
            ...
            <ListGroup variant="flush">
                ...
                <div className="d-flex justify-content-between align-items-start gap-3">
                  <div>
                    ...
                    <div className="text-muted small">
                      Share ideas with a title + content and see the newest
                      posts first.
                    </div>
                  </div>
              ...
              <ListGroup.Item>
                <div className="d-flex justify-content-between align-items-start gap-3">
                  <div>
                    <div className="fw-semibold">Upvote or downvote posts</div>
                    <div className="text-muted small">
                      Upvote or downvote posts that you like or dislike.
                    </div>
                  </div>
                  <Badge bg="light" text="dark">
                    Posts
